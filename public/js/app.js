...
$(document).ready(function () {
  $("button#add-to-cart").on("click", function (e) {
    ...
    var alert = $("<div id='alert-div' class='sticky-top alert alert-dismissible hidden fade show m-3' role='alert'>" + "<p id='alert'></p>" + "<button type='button' class='close' data-dismiss='alert' aria-label='Close'>" + "<span aria-hidden='true'>&times;</span>" + "</button></div>");
    $.ajaxSetup({
      headers: {
