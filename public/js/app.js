  ...
  $("button#add-to-cart").on("click", function (e) {
    ...
    $.ajax({
      ...
      error: function error(data) {
        ...
        var alert = $("<div id='alert-div' class='sticky-top shadow alert alert-danger alert-dismissible fade show m-3' role='alert'>" + "<p id='alert'>" + msg + "</p>" + "<button type='button' class='close' data-dismiss='alert' aria-label='Close'>" + "<span aria-hidden='true'>&times;</span>" + "</button></div>");
        $("#alert-target").html(alert);
      }
    });
  });
